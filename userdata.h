...
private:
    ...
    static const uint ASCII_CODE = 1U << 7U;
    static const uint UTF_BYTE_HEADER = 1U << 7U;

    // UTF-8 1 byte for U+000 - U+007F (7 bits)
    static const uint BITS_OF_CODE_POINT_ONE_BYTE = 1U << 6U;
    // UTF-8 2 bytes for U+0080 - U+07FF (11 bits)
    static const uint BITS_OF_CODE_POINT_TWO_BYTES = 1U << 10U;
    // UTF-8 3 bytes for U+0800 - U+FFFF (16 bits)
    static const uint BITS_OF_CODE_POINT_THREE_BYTES = 1U << 15U;
    // UTF-8 4 bytes for U+10000 - U+1FFFFF (21 bits)
    static const uint BITS_OF_CODE_POINT_FOUR_BYTES = 1U << 20U;
